	...
	<div class="login-wrapper">		
		<div class="login-form-page">
			<div class="login-logo">
				<img src="{{asset('login/img/CC_Logo.png')}}">
			</div>
			<div class="login-heading">
				<h4>Verify Mobile Number</h4>
			</div>
			<div class="otp">
				<p>An OTP has been sent to the entered mobile number  <strong><?php echo Session::get('mobile'); ?> </strong><br> registered email "<strong><?php echo Session::get('email'); ?>"</strong> <a href="{{url('/')}}">Change Number ?</a></p>
			</div>
			<div class="otp-form">
				 <form action="{{ url('login/otp') }}" method="POST">
				 {{csrf_field()}}   
					<div class="otp-pass mb-35">
						<input type="password" maxlength ="1" name="otp" class="inputs" autofocus="autofocus">
						<input type="password" maxlength ="1" name="otp1" class="inputs">
						<input type="password" maxlength ="1" name="otp2" class="inputs">
						<input type="password" maxlength ="1" name="otp3" class="inputs">
							@if ($errors->has('otp'))
				...
				<input type="hidden" name="mobile" maxlength="16" value="<?php echo Session::get('mobile'); ?> ">  
				<input type="hidden"  name="submit" value="Login">											 
				<p>didn`t receive otp? <button type="submit" name="submit" style="color: #FDCD00;border: none;background: none;">Resend</button></p>											
				<p></p>
				</form>
				</div>
