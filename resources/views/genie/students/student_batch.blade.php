...
<div class="student_batch-heading"><h4><?php if($student->batch_name){ echo $student->batch_name; } ?></h4>
</div>
</div>
...
<div class="student-status-heading"><i class="fa fa-book"></i>
...
<div class="student-status-heading"><i class="fa fa-user"></i>
...
<div class="student-status-heading"><i class="fa fa-calendar"></i>
...
<p class="strong-headin2"><?php if($student->batch_created_on){ echo date('d-M-Y',strtotime($student->batch_created_on)); } ?> </p>
</div>
</div>
...
<div class="student-status-heading"><i class="fa fa-clock-o" aria-hidden="true"></i>
...
<div class="student-status-heading"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>
...
<p class="strong-heading"> <strong> Take Live Class </strong></p>
</div>   
...
<div class="batches-live-heading live-batch-footer"><button class="btn btn-live" data-toggle="modal" data-target="#joinfromlaptop_<?php echo $student->id; ?>" ><img src="{{asset('genie/build/images/live-batch-img.png')}}" />Join Live Class </button> 
...
<div class="modal-header"><h5 class="modal-title">Live Class :</h5>
...
<div class="modal-body" style="padding-top:10px;padding-bottom: 12px;"><h6>Dear Student click on Join Button to take live class </h6>
