...
//$currentdate= date('Y-m-d',strtotime($emp_details->created_at));   
 //$startDate = time();
$startDate = strtotime($emp_details->createdat);  
$currentdate = date('Y-m-d', strtotime('-2 months', $startDate)); 
...
if($sal_month == "January") {
	...
	<head>
		<meta charset="utf-8">
		<title>Salary_Slip_<?php echo $emp_details->name.'_'.date_format(date_create(),"d-m-Y"); ?></title>
...
<td valign="middle" style="text-align:left;"> <?php if(!empty($emp_details->name)){ echo $emp_details->name; } ?></td>
</tr>

<tr>
<td style="text-align:left;font-size:13px;font-weight:bold;"> Date of Joining</td>
<td style="text-align:left;"><?php if(!empty($emp_details->dateofjoining)){ echo date('d-M, Y',strtotime($emp_details->dateofjoining)); } ?></td>
...
<td style="text-align:left;"> <?php if(!empty($emp_details->designation)){ echo $emp_details->designation; }  ?></td>
...
<tr>
<td valign="middle" style="border:1px solid #000;font-size:13px;text-align:left;font-weight:bold;"><strong> Net Payable Amount: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-inr"></i> <?php if(!empty($net_pay)){ echo $net_pay;  } ?></strong><br><br> <span style="font-size: 14px;font-weight:500;"> </span></td>
</tr>
