 ...
 <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-book"></i>Course s</span>
              <div class="count"><?php echo (strlen($studentdash[0]->course) > 10 ? substr($studentdash[0]->course,0,10)."..." : $getstudent->course); ?></div>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
			  ...
			  if(isset($feesDue->due_date) && $feesDue->due_date="0000-00-00 00:00:00" ){  echo "N/A"; }else{ echo date('d-M-Y',strtotime($feesDue->due_date)); } ?></div>
