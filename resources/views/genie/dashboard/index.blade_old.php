 ...
 <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count"><?php if($total_students){ echo $total_students+2000; } ?></div>
              <span class="count_bottom"><i class="green">4% </i> From last Month</span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Batch</span>
              <div class="count"><?php if($total_batch){ echo $total_batch+1000; } ?></div>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count green"><?php if($total_trainer){ echo $total_trainer+700; } ?></div>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count"><?php if($total_course){ echo $total_course+200; } ?></div>
              <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>2% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Complete Student</span>
              <div class="count"><?php if($compete_students){ echo $compete_students+5000; } ?></div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>14% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-graduation-cap"></i> Placement Students</span>
              <div class="count"><?php if($placement_students){ echo $placement_students+800; } ?></div>
