                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					if($coursename){
						...
						<?php echo substr(str_replace('?','',$course->heading),0,40); ?></button>
						<div class="panel">
						<ul>						 
						 <?php 
						...
						<div id="getCourseVideoForm_<?php echo (isset($course->id)?$course->id:"")?>" class="modal fade" role="dialog">
							...
							<h5 class="modal-title">Video Upload<div class="succesmessage"></div><div class="errormessage"></div> </h5> 
<button type="button" class="close" data-dismiss="modal">×</button>							
						...
						<script type="text/javascript">$(".vclose_<?php echo (isset($video->id)?$video->id:""); ?>").on('click',function(){
							 
						$("#myModal_<?php echo (isset($video->id)?$video->id:""); ?>").modal("hide");
						$(".theVideo_<?php echo (isset($video->id)?$video->id:""); ?>").get(0).pause();
						});						 
						</script>	
						...
						<button type="button" class="vclose_<?php echo (isset($video->id)?$video->id:""); ?>" data-dismiss="#myModal_<?php echo (isset($video->id)?$video->id:""); ?>">&times;</button>
						</div>
						<div class="modal-body">							 
					...
					<?php 	}} ?>
						...
						<div class="item form-group mb-0 mt-3">
						...
						<div id="getCourseNotesForm_<?php echo (isset($course->id)?$course->id:"")?>" class="modal fade" role="dialog">
							...
							<div class="modal-content">
							<div class="modal-header">
							<h5 class="modal-title">Notes Upload<div class="succesmessage"></div><div class="errormessage"></div> </h5>
<button type="button" class="close" data-dismiss="modal">×</button>							
						...
						<div class="row">
						<div class="col-sm-12">
						<form class="form-horizontal form-label-left" onsubmit="return courseController.saveCourseNotes('<?php echo (isset($course->id)?$course->id:"")?>',this)"  enctype="multipart/form-data" method="POST"> 
						<div class="item form-group mb-0 mt-3">
						...
						<div id="getCourseAssignForm_<?php echo (isset($course->id)?$course->id:"")?>" class="modal fade" role="dialog">
							...
							<div class="modal-content">
							<div class="modal-header">
							<h5 class="modal-title">Assignment Upload<div class="succesmessage"></div><div class="errormessage"></div> </h5> 
<button type="button" class="close" data-dismiss="modal">×</button>							
						...
						<div class="row">
						<div class="col-sm-12">
						<form class="form-horizontal form-label-left" onsubmit="return courseController.saveCourseAssignment('<?php echo (isset($course->id)?$course->id:"")?>',this)"  enctype="multipart/form-data" method="POST"> 
						<div class="item form-group mt-3 mb-0">
